public class MainTesteCarrinho {
    public static void main(String[] args) {
        ...
        Sistema.getInstancia().adiconarProdutoEstoque("Estoque1","PROD-00000001", 5);
        Sistema.getInstancia().adiconarProdutoEstoque("Estoque1","PROD-00000002", 2);
        ...
        Sistema.getInstancia().cadastrarCliente(null, null, null);
